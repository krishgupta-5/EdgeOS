...
export default function FeaturesSection() {
    return (<section id="features" className="relative min-h-screen p-12 py-10 sm:py-12 md:py-14 lg:py-16 xl:py-20 snap-start flex flex-col justify-center">
            
            <div className="relative z-10 w-[92%] md:w-[88%] lg:w-[90%] mx-auto flex flex-col items-center gap-4 mb-8 sm:mb-10 md:mb-12">
                <div className="flex h-8 items-center gap-2 rounded-[11px] border border-[#8B5CF6] bg-[#F04D]/5 px-2.5 text-xs font-medium text-white/75 shadow-[0_8px_24px_-14px_rgba(0,0,0,0.6)]">
