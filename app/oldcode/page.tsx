...
import TemplateGrid from "@/oldcomponents/TemplateGrid";
import YamlViewer from "@/oldcomponents/YamlViewer";
import ChatBox from "@/oldcomponents/ChatBox";
      ...
      <div className="flex-1 min-h-0 flex flex-col max-w-[1800px] mx-auto w-full p-4 lg:p-6 gap-6">
        ...
        <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 flex flex-col h-full min-h-0">
            <h2 className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2 shrink-0">
